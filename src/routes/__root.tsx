...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A Monkeytype-style Morse code typing trainer. Learn the alphabet and race against your WPM." },
      { property: "og:title", content: "MorseType — Practice Morse code, fast." },
      { property: "og:description", content: "A Monkeytype-style Morse code typing trainer. Learn the alphabet and race against your WPM." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "MorseType — Practice Morse code, fast." },
      { name: "twitter:description", content: "A Monkeytype-style Morse code typing trainer. Learn the alphabet and race against your WPM." },
